...
*Code ist sexy & hart. Keine Diskussionen. Bitte vertraulich behandeln, Sarge.*
...
<details>
<summary>📑 Briefing mit Tanya</summary>
...
[ ] Testet zuerst die Engine, dann die Mods, nicht alles auf einmal.
...
[ ] Multiplayer vorher in Low-Res testen, spart Zeit & Ressourcen.
...
[ ] Testet Änderungen in kleinen Schritten.

### B. Renegade (W3D-Engine)

| Projekt             | Beschreibung                              | Link                                  |
| :------------------ | :---------------------------------------- | :------------------------------------ |
| **W3DHub Projekte** | Dachorganisation für Renegade-Mods        | [w3dhub.com](https://www.w3dhub.com/) |

*Tanya: „Renegade X & Co – nutzt den GPL-Core, dann wird’s richtig stark.“*  
[ ] Alle Modding-Tools dokumentieren, Lizenz prüfen.
...
[ ] Alle proprietären Assets ersetzen → echtes FOSS-Projekt.
...
| **CnCNet Lobby / Clients** | Multiplayer testen, Patches & Mods online | [cncnet.org/downloads](https://cncnet.org/downloads)               |
...
4. Jede Mod sauber dokumentieren, Links & Lizenz angeben  
